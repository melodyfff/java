...
/**
 * 按照树形结构直观地打印出一棵二叉树(Java) : https://blog.csdn.net/lenfranky/article/details/89645755
 *
 *
 * @author Xin Chen (xinchenmelody@gmail.com)
 * @version 1.0
 * @date Created In 2022/8/28 22:36
 */
public class TreePrinter {
    ...
    public static int getTreeDepth(Node root) {
        return root == null ? 0 : (1 + Math.max(getTreeDepth(root.getLeftNode()), getTreeDepth(root.getLeftNode())));
    }
