...
/**
 * @author xinchen 2016年10月17日 下午10:34:08
 * @Description:
 */
public class IOStreamDemo {
     ...
     * 日志类
     */
    private final static Logger LOGGER = LoggerFactory.getLogger(IOStreamDemo.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            LOGGER.error("args is empty:{}",e.getCause());
        }
    }
}
